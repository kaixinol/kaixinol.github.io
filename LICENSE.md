...
This project is licensed under a dual-licensing model to distinguish between its software source code and creative content.

---

### 1. Software Code

All source code and executable files in this repository are licensed under the **MIT License**.

- **License File:** [LICENSE-MIT.md](./LICENSE-MIT.md)
- **Permitted Use:** Commercial use, modification, distribution, and private use.

### 2. Documentation and Creative Content
...
_Copyright (c) 2026-present Kaesinol_
